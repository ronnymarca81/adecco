...
- Kanban Board Page: It will have three lists with preconfigured activities [All, Work in progress and Done], where you can drag and drop between the rows to organize them and sort tasks in a list or move a task to another list. Additionally, you can change the title     of the lists or description of the tasks, as well as delete lists and tasks.
